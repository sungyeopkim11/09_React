...
const ChildPw = (props) => {
  ...
  return(
    <div className='wrapper'>
      ...
      <input type="password" id="inputPw" onChange={handeler}/>
    </div>
  );
}
...
const ParentComponent = () => {
  ...
  const idHandler = e => {
    // e : 이벤트 객체
    setId(e.target.value); // input에 작성된 값이 변하면 상태 변수 id 값을 바꿔서 리랜더링 수행
  }
  ...
  return(
    <>
      <ChildId handeler={idHandler}/>
      <ChildPw handeler={pwHandler}/>
